...
const ListItem = (props) => {
    ...
    const showDeletePopup = () => setDeletePopupVisible(true);
    const hideDeletePopup = () => setDeletePopupVisible(false);
    ...
    const deletePopup = (<Modal show={deletePopupVisible} onHide={hideDeletePopup}>
            <Modal.Header closeButton>
                <Modal.Title>Confirm Delete!</Modal.Title>
            </Modal.Header>
            <Modal.Body>Are you sure, you want to delete this blog?</Modal.Body>
            <Modal.Footer>
                <Button variant="secondary" onClick={hideDeletePopup}>Cancel</Button>
